...
- Generated: `2026-01-26T14:39:47.379050+00:00`
...
- Range scanned: `23,671,625..24,319,625` (~90d)
- Exit events: **369**
...
- hold_no_first_hop: **19** events; **6,122,287.676 CRV** (66.91%)
- unknown_contract: **14** events; **878,458.980 CRV** (9.60%)
- unknown_eoa: **7** events; **949,720.617 CRV** (10.38%)
- dex_router_interaction: **6** events; **722,991.996 CRV** (7.90%)
...
- no_first_hop_meeting_threshold: **23** events; **6,635,360.574 CRV** exited
- unknown_contract: **16** events; **1,088,378.079 CRV** exited
- unknown_eoa: **11** events; **1,425,696.613 CRV** exited
...
Raw output: see `research/curve-vecrv-exit-routing-3d.json`.
